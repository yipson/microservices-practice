package com.formacion.bdi.springboot.app.zuul.oauth;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConf.setAllowedMethods(Arrays.asList("POST", "GET", "PUT", "DELETE", "OPTIONS"));
        corsConf.setAllowCredentials(true);
        corsConf.setAllowedHeaders(Arrays.asList("Authorization", "Content-Type"));
